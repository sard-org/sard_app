...
import 'bloc/iphone_14_fortythree_bloc.dart';
import 'models/iphone_14_fortythree_model.dart';

class Iphone14FortythreeScreen extends StatelessWidget {
  const Iphone14FortythreeScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<Iphone14FortythreeBloc>(
      create: (context) => Iphone14FortythreeBloc(Iphone14FortythreeState(
        iphone14FortythreeModelObj: Iphone14FortythreeModel(),
      ))..add(Iphone14FortythreeInitialEvent()),
      child: Iphone14FortythreeScreen(),
    );
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<Iphone14FortythreeBloc, Iphone14FortythreeState>(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            CustomImageView(
                              imagePath: ImageConstant.imgkat0200001,
                              height: 238.h,
                              width: 186.h,
                            ...
                            _buildHorizontalScrollBooks(context),
                          ],
                        ),
                      ),
                    ],
                ...
                RichText(
                  text: TextSpan(
                    children: [
                      TextSpan(
                        text: "lbl_396".tr,
                        style: CustomTextStyles.headlineSmallBluegray90001_1,
                      ),
                      TextSpan(
                        text: "lbl10".tr,
  ...
  Widget _buildHorizontalScrollBooks(BuildContext context) {
