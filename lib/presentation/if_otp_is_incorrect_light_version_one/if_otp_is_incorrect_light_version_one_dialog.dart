...
import 'bloc/if_otp_is_incorrect_light_version_one_bloc.dart';
import 'models/if_otp_is_incorrect_light_version_one_model.dart';

class IfOtpIsIncorrectLightVersionOneDialog extends StatelessWidget {
  const IfOtpIsIncorrectLightVersionOneDialog({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider(
      create: (context) => IfOtpIsIncorrectLightVersionOneBloc(
        IfOtpIsIncorrectLightVersionOneState(
          ifOtpIsIncorrectLightVersionOneModelObj:
              IfOtpIsIncorrectLightVersionOneModel(),
        ),
      )..add(IfOtpIsIncorrectLightVersionOneInitialEvent()),
      child: const IfOtpIsIncorrectLightVersionOneDialog(),
    );
  }
